...
export default class MyPlugin extends Plugin {
	...
	async onload() {
		...
		const ribbonIconEl = this.addRibbonIcon('dice', 'Sample Plugin', (evt: MouseEvent) => {
			...
			new Notice('This is a notice123!');
		});

		// const commitViewBtn = this.addRibbonIcon('info', 'Commit View', (evt: MouseEvent) => {
		this.addRibbonIcon('info', 'Commit View', (evt: MouseEvent) => {
			this.activateView();
			new Notice('Leaf added');
		});
